...
@NgModule({
  declarations: [
    ...
    VerificationComponent,
        UpdateETAComponent,
        SetDischargeConnectTimestampComponent,
        SetDischargeDisconnectTimestampComponent,
        SetLoadingNORTemperedTimestampComponent,
        SetLoadingDocumentsOnBoardTimestampComponent,
