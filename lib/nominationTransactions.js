...
async function finalizeNomination(transaction)
{
    ...
    event.chartererEmail = transaction.nomination.charterer.email;
    event.voyageMangerEmail = transaction.nomination.voyageManager.email;
    event.shippingCompanyEmail = transaction.nomination.shippingCompany.email;
