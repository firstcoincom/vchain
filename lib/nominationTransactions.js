...
{
    var factory = getFactory();
    var nom = transaction.nomination;
    ...
    var load = loadingDocs[0];
    var discharge = dischargeDocs[0];
    ...
    var dob = load.documentsOnBoard.getTime() / msPerHour;
    var nor = load.NORTendered.getTime() / msPerHour;

    var loadLaytime = (dob - nor + 6) / 24;
    ...
    var hc = discharge.hoseConnected.getTime() / msPerHour;
    var hdc = discharge.hoseDisconnected.getTime() / msPerHour;

    var dischargeLaytime = (hc - hdc) / 24;
